...
- [proxy_advise_before_meeting](../../../wiki/tools/proxy_advise_before_meeting.md) — pre-meeting voting recommendation
- [shareholder_meeting_notice](../../../wiki/tools/shareholder_meeting_notice.md) — agenda / nominee structuring
- [financial_metrics](../../../wiki/tools/financial_metrics.md) — tenure-performance metrics
- [proxy voting decision tree](../../../wiki/architecture/proxy-voting-decision-tree.md) — decision framework
